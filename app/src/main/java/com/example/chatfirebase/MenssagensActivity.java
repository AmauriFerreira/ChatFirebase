...
public class MenssagensActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_menssagens);
    ...
    private  void verifyAuthentication(){
        if (FirebaseAuth.getInstance().getUid()==null){
            Intent intent= new Intent(MenssagensActivity.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.contacts:
              Intent  intent= new Intent(MenssagensActivity.this, ContactsActivity.class);
              startActivity(intent);
                break;
            case R.id.logout:
    ...
    private class ContactItem extends Item<ViewHolder> {
        ...
        public void bind(@NonNull ViewHolder viewHolder, int position) {
            ...
            TextView usernome = viewHolder.itemView.findViewById(R.id.textView);
            ...
            usernome.setText(contact.getUsernome());
